...
// otherwise. It is written into no file — a profile with nothing of its own reads back as this,
// so it is on the profile's own page to be edited like any other.
