import { RESERVED } from '@daemon/constants/files'
import { mkdir, readFile, readdir, rename, rm, stat } from 'node:fs/promises'
import path from 'node:path'
import { atomicWrite, resolveInRoot } from '@daemon/utils/fs'
import { Git } from '@daemon/utils/git'
import { PathError, normalize } from '@daemon/utils/path'
import type { DocPath, TreeEntry } from '@daemon/types/doc'
